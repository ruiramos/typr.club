...
Object.assign(topbar, view, {
  template: '<span class="content">' +
              '<span class="title">' +
                ...
                // '<span class="subtitle">You can also go on a private room, here\'s a random one: <a data-hook="rand-link" href=""></a></span>' +
                //'<span class="help"><a href="/help">Need help?</a></span>' +
              '</span>' +
