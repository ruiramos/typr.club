...
function shareMessage(id, room){
  var slack = window.slackHook || 'https://hooks.slack.com/services/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';
  if(room === 'ometria'){
    slack = 'https://hooks.slack.com/services/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';
  }
  setTimeout(function(){
    $.post(slack, {
